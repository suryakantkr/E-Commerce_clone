        ...
        <div className="productdiplay">
            ...
            <div className="productdiplay-right">
                ...
                <div className="productdisplay-right-prices">
                    <div className="productdisplay-right-price-oldd">${product.old_price}</div>
                    <div className="productdisplay-right-price-new">${product.new_price}</div>
                </div>
                <div className="productdisplay-right-discription">
                    A lightweight, usually knitted, pollover shirt, close-fitting and with a 
                    round neckline and short sleeves, worn as undershirt or outer garment.
                </div>
